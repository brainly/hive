...
This section describes the monitoring facilities of the Hive server. Statistics gathering is performed by changing values of various in-memory counters during Hive run-time, using \ref{folsom} external library. All counters are represented by \textbf{non-negative integers}, and each of them corresponds to a specific metric of the Hive server.
